# file_generator.py
# Generate Excel DATA and META files for Novartis Pension Fund dataset
...
class NovartisFileGenerator:
    ...
    def create_data_file(self, data_records, output_path):
        ...
        # Format for large numbers (CHF millions): #,##0.00
    ...
    def generate_files(self, parsed_data, output_dir):
        ...
        latest_data_path = os.path.join(latest_dir, f"CHEF_NOVARTIS_DATA_latest.xls")
        latest_meta_path = os.path.join(latest_dir, f"CHEF_NOVARTIS_META_latest.xls")
        latest_zip_path = os.path.join(latest_dir, f"CHEF_NOVARTIS_latest.zip")
